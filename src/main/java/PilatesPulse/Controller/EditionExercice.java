...
public class EditionExercice implements Initializable {
    ...
    public void Modifier(javafx.event.ActionEvent actionEvent) {
        ...
        {
        exp.Edit(ID,NomExercice.getText(), UserSession.getId(),Difficulte.getValue(), (int) Evaluation.getValue(),Muscle.getValue(),t.replace("/", "\\").replace("file:\\",""),t1.replace("/", "\\").replace("file:\\",""));
