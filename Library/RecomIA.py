...
def muscle_prediction(new_sexe, new_age, new_height, new_weight):
    ...
    def predict_muscle(sexe, age, height, weight):
        ...
        return muscle_names[int(predicted_muscle) - 1]

    predicted_muscle_name = predict_muscle(new_sexe, new_age, new_height, new_weight)

    print(predicted_muscle_name)

    return predicted_muscle_name
